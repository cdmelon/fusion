...
def get_args_parser():
    ...
    parser.add_argument("--model_type", default='paie', choices=["paie", "t5p"], type=str,  # _______________
                        help="which types of model you would use. model with multi-prompt(paie) or single-prompt(base)")
    parser.add_argument("--model_name_or_path", default="./bart", type=str,    # ______________________
    ...
    parser.add_argument("--role_path", default='./data/dset_meta/description_wikievent.csv', type=str, #  ______________________
                        help="a file containing all role names. Read it to access all argument roles of this dataset")
    parser.add_argument("--prompt_path", default='./data/prompts/prompts_wikievent_full.csv', type=str, #  ______________________
                        help="a file containing all prompts we use for this dataset")
    parser.add_argument("--output_dir", default='./outputs_res1', type=str,     #  ______________________
    ...
    parser.add_argument("--batch_size", default=4, type=int,
                        help="batch size during training. with BP") #______________________
    ...
    parser.add_argument("--device", default='cuda', type=str)     #   ______________________________
    ...
    parser.add_argument("--max_prompt_seq_length", default=100, type=int, # _______________________________
