...
class BaseRunner:
    ...
    def train(self):
        ...
        for global_step in range(self.cfg.max_steps):
            ...
            self.model.set_step(global_step, self.cfg.max_steps)
...
class Runner(BaseRunner):
    ...
    def eval_and_update(self, global_step):
        ...
        wandb.log({("best dev-f1 score"): self.metric["best_dev_f1"]})
        wandb.log({("related test-f1 score"): self.metric["related_test_f1"]})
